...
[Obsolete(message:"Verificar el uso de esta clase")]
public class ProductoFactura_V2
{
    ...
    public ProductoFactura_V2(int code, int quantity, decimal unitPrice, double discount, double recargo, double iva,
